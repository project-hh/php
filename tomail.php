<?php
	$config['smtp_username'] = 'noreplay@mail.ru';  //Смените на имя своего почтового ящика.
	$config['smtp_port']	 = '25'; // Порт работы. Не меняйте, если не уверены.
	$config['smtp_host']	 = '14:88';  //сервер для отправки почты
	$config['smtp_password'] = 'vsdfsdfsdfsdfsfsdfsdfsf8t';  //Измените пароль
	$config['smtp_debug']	= true;  //Если Вы хотите видеть сообщения ошибок, укажите true вместо false
	$config['smtp_charset']  = 'UTF-8';	//кодировка сообщений. (или UTF-8, итд)
	$config['smtp_from']	 = 'Образовательный портал Академии'; //Ваше имя - или имя Вашего сайта. Будет показывать при прочтении в поле "От кого"
...
$headers .= $jhgdsjg;
smtpmail('h@phcm.ru', 'Тема письма', $message, $headers);
